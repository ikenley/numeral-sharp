...
namespace NumeralSharp.Formats
{
    public class NumberFormatter
    {
        ...
        public virtual string NumberToFormat(double? value, string format, NumeralOptions options)
        {
        ...
        protected static string ToFixed(double value, int maxDecimals, string roundingFunction = null, int optionals = 0)
        {
            //Gordian Knot
